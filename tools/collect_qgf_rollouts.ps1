...
$remoteCommand = @"
cd '$remoteProject' && export SMOLVLA_TASK_B64='$taskBase64' QGF_NOTES_B64='$notesBase64' QGF_EPISODE_COUNT='$EpisodeCount' QGF_DATASET_ROOT='$DatasetRoot' && ./tools/run_qgf_collection_session.sh
"@.Trim()
